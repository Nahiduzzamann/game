...
import { agents, banner, bonusHistory, deposit, gameHistory, games,
   notification, promotionHistory, promotions, rewardsHistory,
    rewardsList, userWallets, users, voucher, wallets, withdraw } from "../schema/gameSchema.js";
