...
import { addRewards, addVoucher, applyVoucher, collectRewards,
     deleteRewards, getRewards, getRewardsHistory,
      getUserRewards, getVoucher } from '../controllers/rewardsController.js';
const upload = multer()
