...
import {
    addSlider, changePasswordAgents, createPromotion, deletePromotion,
    deleteSlider, depositHistory, depositReport, getAllUser, getNotificationAdmin,
    getNotificationUser, getSlider, getUnreadNotificationCount, getUnreadNotificationCountUser,
    loginAgents, registerAgents, revenueReport, toggleStatusDeposit, toggleStatusWithdraw, turnOverHistory, withdrawHistory
