...
export const signUp = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const token = jwt.sign({ username: newUser.username }, process.env.JWT_SECRET as string, { expiresIn: '7d' });
...
export const login = async (req: Request, res: Response) => {
  try {
    ...
    const token = jwt.sign({ username: user.username }, process.env.JWT_SECRET as string, { expiresIn: '7d' });
