import { GameHistory } from '../data/allTypes.js';
...
import RootObject, { Welcome10 } from '../data/gamesTypes.js';
...
import { GameTypes, Providers } from '../data/gameDataTypes.js';
import { AuthenticatedRequest } from '../middlewares/checkLogin.js';
import { UserModel } from '../data/allTypes.js';
...
const typedProviders = providers as Providers[];
const typedCategories = categories as CategoryTypes;
