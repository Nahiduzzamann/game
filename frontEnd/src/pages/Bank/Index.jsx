...
export default function BankPay() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoader(true);
      await makeDeposit(walletId,walletInfo.depositChannel==="Dpay" ?amount:parseInt(amount)+(parseInt(amount)*1.5)/100, promotionId, tranXId);
      toast({
  ...
  return (
    <div className="w-screen h-screen bg-blue-500 p-3">
      ...
      <div className="w-full flex flex-wrap justify-center my-4">
        ...
        {walletInfo?.depositChannel==="Dpay"?(
