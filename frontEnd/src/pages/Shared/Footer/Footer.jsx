    ...
    return (
        <div className='bg-slate-200'>
                ...
                <div className='pt-5'>
                    <p className='font-bold h2 pb-4'>Bangladesh's Best Cricket Exchange</p>
                       <p>Play with the premium cricket exchange in Bangladesh.
                        ...
                        <p>Online Casino Bangladesh BABU88 provides you with the largest suite of games that have
                         interesting gameplays and great rewards upon winning. Popular developers such as
                          ...
                          are all available at BABU88. Choose BABU88 for the Best Online Casino Bangladesh Experience
                          BABU88 is an exclusive live casino and sportsbook provider with over 1000+ games to choose from
                          Look no further as you can find Super Spade Gaming, AE Casino and Evo Gaming and Pragmatic Play 
                          over at BABU88! Register with only afew details and you will be able to play live casino games
                          like Baccarat, Roulette, Blackjack and Sicbo at BABU88.</p>
                  </div>

                  <div className='pt-5'>
                    <p className='font-bold h2 pb-4'>Sports Betting</p>
                       <p>BABU88 has the leading sportsbook that are well known to 
                       ...
                       Find all live scores over at BABU88 with free livestreaming. Register and open up our app, 
                       with tons of variations to play with, you will have the best experience and mobile sportsbook at BABU88
                      BABU88 has an exclusive sportsbook for sports related activities and all your favourite sports.
                  ...
                  <div className='pt-5'>
                    <p className='font-bold h2 pb-4'>Bangladesh's Premium Cricket Exchange</p>
                       <p>Bangladesh's only premium casino with an online betting pass. Get up to 100 FREE rewards by participating in BABU88's VIP Pass. Play 
                        premium cricket exchange at BABU88 and get rewarded! Bet ICC, bet IPL, bet T20, bet BBL,
                         bet CPL, bet Test Cricket with us at BABU88 and get rewarded!</p><br></br>
            ...
            <div className='grid grid-cols-1 pt-5'>
                <div className=''>
                    <p className='h2 pt-5'>Copyright © 2024 Babu88.All rights are reserved.</p>
                </div>
