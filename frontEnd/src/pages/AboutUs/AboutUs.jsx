  ...
  return (
    <div className="p-5">
      ...
      <p className="font-bold pt-5 pb-2 underline underline-offset-5">
        ...
        {
          isEnglish ? " Sports Betting":"ক্রীড়া পণ"
        }
      </p>
      <p className="font-medium">
      {
          isEnglish ? "40XBET provides extensive sports betting opportunities. Users can place bets on various sports events including IPL, World Cup, Big Bash League, CPL, T20, Test Cricket, and ICC matches."
      ...
      <p className="font-bold pt-5 pb-2 underline underline-offset-5">
        ...
        {
          isEnglish ? "Casino Games":"ক্যাসিনো গেম"
        }
      </p>
      <p className="font-medium">
      {
          isEnglish ? "40XBET offers a range of casino games. Users can enjoy games like roulette, poker, baccarat, as well as all the latest live casino trendsfrom industry leading providers like Pragmatic Play or Evolution Gaming."
      ...
      <p className="font-bold pt-5 pb-2 underline underline-offset-5">
        ...
        {
          isEnglish ? "Mobile Application":"মোবাইল অ্যাপ্লিকেশন"
        }
      </p>
      <p className="font-medium">
        {
          isEnglish ? "40XBET offers a mobile application that replicates all the gambling features found on the official site. The app provides a more streamlined and expeditious interface for users."
