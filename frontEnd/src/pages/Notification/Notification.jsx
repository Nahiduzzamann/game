  ...
  return (
    ...
    <div className="p-5 bg-white rounded-md">
      {loading ? (
        ...
        .map((notification) => (
            <div onClick={()=>handleNavigate(notification.type)} key={notification._id} className={`${notification.read ? 'bg-gray-500':'bg-yellow-300'}  rounded-lg cursor-pointer p-1 mb-1 shadow-lg hover:shadow-blue-500`}>
