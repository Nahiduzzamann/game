...
import { bonusHistory, deposit, gameHistory, games, promotionHistory, promotions, rewardsHistory, rewardsList, userWallets, users, voucher, wallets, withdraw } from "../schema/gameSchema";
