...
import { createPromotions, createUserWallet, createWallet, createWithdraw, deleteUserWallets, getDeposit, getPromotions, getUserWallets, getWallets, makeDeposit } from '../controllers/balanceContoller';
const upload = multer()
