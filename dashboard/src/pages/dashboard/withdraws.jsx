...
console.log(err);
    ...
    <span class="text-red">{data.status}</span>
      ...
      <Dialog open={open}>
        <div className='flex justify-between items-center m-4 text-2xl'><span>Withdraw Amount: <span className='text-red-500 font-semibold'>{actionData?.amount}</span>tk</span> <p onClick={handleOpen} className='border border-red-500 p-1 rounded-md'>X</p></div>
        <DialogBody>
        <input
